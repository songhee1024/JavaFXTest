...
public class NaverTranslator { // 네이버 번역 (Papago SMT) API
    ...
    public static String translate(String input) {
        ...
        try {
            ...
            con.setRequestProperty("X-Naver-Client-Secret", clientSecret);
                ...
                String postParams = "source=ko&target=en&text=" + text; //한국어를 영어로
    ...
    private static String parseJson(String json) throws Exception { //값을 가져옴
